            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <?php echo form_open(); ?>
                        <input type="hidden" value="<?php echo $Ogrenci->Id ?>" name="Id">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="tb-fname" name="Ad"
                                           placeholder="Başlık Giriniz" value="<?php echo $Ogrenci->Ad ?>">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="email" class="form-control" id="tb-fname" name="Email"
                                           value="<?php echo $Ogrenci->Email ?>">
                                </div>
                            </div>

                            <div class="col-md-12">
                                <div class="mb-3">
                                    <label for="tb-fname">Öğrenci No</label>
                                    <input type="text" class="form-control" id="tb-fname" name="ogrencino"
                                           value="<?php echo $Ogrenci->ogrencino ?>">
                                </div>
                            </div>
