        ...
        <div class="theme-option pb-4">
            ...
            <div class="d-flex align-items-center gap-3 my-3">
                <a href="javascript:void(0)"
                   onclick="toggleTheme('<?php echo base_url() ?>assets/backend/css/style.min.css')"
                   class="rounded-2 p-9 customizer-box hover-img d-flex align-items-center gap-2 light-theme text-dark">
                    <i class="ti ti-brightness-up fs-7 text-primary"></i>
                    <span class="text-dark">Light</span>
                </a>
                <a href="javascript:void(0)"
                   onclick="toggleTheme('<?php echo base_url() ?>assets/backend/css/style-dark.min.css')"
                ...
                <ul class="list-unstyled mb-0 d-flex gap-3 flex-wrap change-colors">
                    ...
                    <li class="rounded-2 p-9 customizer-box hover-img d-flex align-items-center justify-content-center">
                        <a href="javascript:void(0)"
                           ...
                           onclick="toggleTheme('<?php echo base_url() ?>assets/backend/css/style-aqua.min.css')"
                    ...
                    <li class="rounded-2 p-9 customizer-box hover-img d-flex align-items-center justify-content-center">
                        <a href="javascript:void(0)"
                           ...
                           onclick="toggleTheme('<?php echo base_url() ?>assets/backend/css/style-purple.min.css')"
                    ...
                    <li class="rounded-2 p-9 customizer-box hover-img d-flex align-items-center justify-content-center">
                        <a href="javascript:void(0)"
                           ...
                           onclick="toggleTheme('<?php echo base_url() ?>assets/backend/css/style-green.min.css')"
                    ...
                    <li class="rounded-2 p-9 customizer-box hover-img d-flex align-items-center justify-content-center">
                        <a href="javascript:void(0)"
                           ...
                           onclick="toggleTheme('<?php echo base_url() ?>assets/backend/css/style-cyan.min.css')"
                    ...
                    <li class="rounded-2 p-9 customizer-box hover-img d-flex align-items-center justify-content-center">
                        <a href="javascript:void(0)"
                           ...
                           onclick="toggleTheme('<?php echo base_url() ?>assets/backend/css/style-orange.min.css')"
...
<script src="<?php echo base_url() ?>assets/backend/libs/owl.carousel/dist/owl.carousel.min.js"></script>
<script src="<?php echo base_url() ?>assets/backend/libs/apexcharts/dist/apexcharts.min.js"></script>
<script src="<?php echo base_url() ?>assets/backend/js/dashboard.js"></script>
<script src="<?php echo base_url() ?>assets/backend/js/apps/chat.js"></script>22
<script src="<?php echo base_url() ?>assets/backend/libs/prismjs/prism.js"></script>


<script src="<?php echo base_url() ?>assets/backend/libs/datatables.net/js/jquery.dataTables.min.js"></script>
<script src="<?php echo base_url() ?>assets/backend/js/datatable/datatable-basic.init.js"></script>
