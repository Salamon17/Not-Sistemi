                    ...
                    <div class="card mb-0">
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="exampleInputtext" name="Surname"
                                       aria-describedby="textHelp">
                            </div>
                            <div class="mb-3">
                            ...
                            <button type="submit" class="btn btn-primary w-100 py-8 mb-4 rounded-2">Kayıt Ol</button>
                            <div class="d-flex align-items-center">
                                <p class="fs-4 mb-0 text-dark">Hesabın Var mı?</p>
                                <a class="text-primary fw-medium ms-2" href="<?php echo base_url() ?>">Giriş Yap</a>
                            </div>
                            <?php echo form_close() ?>
